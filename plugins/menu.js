...
%readmore`.trimStart(),
  ...
  footer: '',
  after: `VynaBotz-Md masih dalam tahap pengembangan.
`,
}
...
// Fake Contact
 const fcon = {
    ...
    conn.sendButton(m.chat, text.trim(),"2023 © VynaBotz-Md", await (await fetch(thumb)).buffer(), [['Owner', '.owner'],['Donasi', '.donasi'],['Speed', '.speed']], true, { quoted: m })
